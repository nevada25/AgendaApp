package com.example.nevada26.agendaapp.Dialogs;
...
import com.example.nevada26.agendaapp.activity.SettingsActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.card_view1:
                ...
                ((SettingsActivity) getActivity()).setThemeFragment(1);
                break;
            case R.id.card_view2:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((SettingsActivity) getActivity()).setThemeFragment(2);
                break;
            case R.id.card_view3:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((SettingsActivity) getActivity()).setThemeFragment(3);
                break;
            case R.id.card_view4:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((SettingsActivity) getActivity()).setThemeFragment(4);
                break;
            case R.id.card_view5:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((SettingsActivity) getActivity()).setThemeFragment(5);
                break;
            case R.id.card_view6:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((SettingsActivity) getActivity()).setThemeFragment(6);
                break;
            case R.id.card_view7:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((SettingsActivity) getActivity()).setThemeFragment(7);
                break;
            case R.id.card_view8:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((SettingsActivity) getActivity()).setThemeFragment(8);
                break;
            case R.id.card_view9:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((SettingsActivity) getActivity()).setThemeFragment(9);
                break;
            case R.id.card_view10:
                sharedPreferences.edit().putBoolean("THEMECHANGED", true).apply();
                ((SettingsActivity) getActivity()).setThemeFragment(10);
                break;
            case R.id.buttonDisagree:
                sharedPreferences.edit().putBoolean("THEMECHANGED", false).apply();
                ((SettingsActivity) getActivity()).setThemeFragment(currentTheme);
                getDialog().dismiss();
                break;
